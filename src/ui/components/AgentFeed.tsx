              ...
              >
                ...
                <ul className="patchcard__diff">
                  {entry.summary.length === 0 && (
                    <li className="patchcard__change num">
                      no structural change — the patch was a no-op against the pack
                    </li>
                  )}
      ...
      <div className="agentfeed__foot">
        <span>
          {entries.length === 0
            ...
            : `${entries.length} approved change${entries.length === 1 ? '' : 's'}`}
        </span>
        <span className="agentfeed__foot-note">simulated · approved · applied</span>
      </div>
    </section>
  );
}
